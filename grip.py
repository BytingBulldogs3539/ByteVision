...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__cv_gaussianblur_src = self.resize_image_output
        self.__cv_gaussianblur_ksize = (1, 1)
        self.__cv_gaussianblur_sigmax = 7.0
        self.__cv_gaussianblur_sigmay = 7.0
        ...
        self.__hsv_threshold_hue = [33.99280575539568, 52.525597269624576]
        self.__hsv_threshold_saturation = [135.29676258992808, 255.0]
        self.__hsv_threshold_value = [45.86330935251798, 224.53924914675767]
